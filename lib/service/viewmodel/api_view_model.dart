...
getCurrentOrder() => <CurrentOrderResponse>[
      CurrentOrderResponse(
          orderId: '1',
          shopName: 'Agha laundry',
          shopAddress: 'Abu Dhabi',
          shopMobileNo: 'Shop mobile',
...
List<DryWashResponse> getDryWash() {
  ...
  List<DryWashItem> dryWashMenItem,
      dryWashWomenItem,
      dryWashKidsItem,
      dryWashHomeItem;
  dryWashMenItem = List();
  ...
  dryWashList.add(
      DryWashResponse(id: 1, dryWashItemList: dryWashMenItem, name: 'Men'));
  dryWashList.add(
      DryWashResponse(id: 2, dryWashItemList: dryWashWomenItem, name: 'Women'));
  dryWashList.add(
      DryWashResponse(id: 3, dryWashItemList: dryWashKidsItem, name: 'Kids'));
  dryWashList.add(
      DryWashResponse(id: 4, dryWashItemList: dryWashHomeItem, name: 'Home'));
...
List<SelectWashShopResponse> getSelectWashShop() {
  ...
  selectWashMaster_1.add(SelectWashMaster(
      shopId: 1,
      menuId: 1,
      menuName: 'Men',
      categoryName: 'Pant',
  ...
  selectWashMaster_1.add(SelectWashMaster(
      ...
      water: 20,
      price: 400,
      washShopStatus: false));

  selectWashMaster_2 = List();
  selectWashMaster_2.add(SelectWashMaster(
      shopId: 2,
      menuId: 1,
      menuName: 'Men',
      categoryName: 'Pant',
  ...
  selectWashShopList.add(SelectWashShopResponse(
      id: 1,
      city: 'Ahmedabad',
      area: 'Nikol',
      name: 'Chirag drycleaners',
      address: '25 Shreyance Park Society Pancham Mall Opposite Nikol Gam Road',
      selectWashMasterList: selectWashMaster_1));
  selectWashShopList.add(SelectWashShopResponse(
      id: 2,
      city: 'Ahmedabad',
      area: 'Nikol',
      name: 'Dharmendra Dry Cleaners & Petrol Wash',
      address:
          'Shopping Center, Mama Kalyan Circle, 7, Nikol-Naroda Rd, Padmavatinagar Society, Nava Naroda',
      selectWashMasterList: selectWashMaster_2));
  selectWashShopList.add(SelectWashShopResponse(
      id: 2,
      city: 'Surat',
      area: 'Athwa',
      name: 'Green Clean Dry Cleaners',
      address: '2, City Light Rd, Panas Gam, City Light Town, Athwa',
      selectWashMasterList: selectWashMaster_2));
